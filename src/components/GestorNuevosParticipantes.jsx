...
export default function GestorNuevosParticipantes() {
  ...
  // ================= LÓGICA DE CARGA MASIVA (Intacta) =================
  ...
  if (accesoDenegado) {
    return (
      <div className="bg-red-50 border border-red-200 p-8 rounded-2xl flex flex-col items-center justify-center text-center max-w-md mx-auto mt-10">
        ...
        <p className="text-red-600">No tienes los permisos necesarios para importar bases de datos. Esta acción es exclusiva para Administradores o Coordinadores.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto pb-12">
      ...
      {/* ================= VISTA MODO MASIVO (Tu código original integrado) ================= */}
      {modoIngreso === 'masivo' && (
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 animate-fade-in">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Paso 1: Cargar Archivo</h2>
          <p className="text-gray-500 mb-6 text-sm">
            Si el participante ya existe, no lo duplicará, actualizará su información. Si es nuevo, le generará un código.
          </p>
        ...
        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-sm border border-gray-100 animate-fade-in max-w-2xl mx-auto">
          ...
          <form onSubmit={handleGuardarManual} className="space-y-5">
            <div>
              ...
              <input type="text" required value={manualNombre} onChange={(e) => setManualNombre(e.target.value)} className="w-full p-3 border border-gray-300 rounded-xl outline-none focus:ring-2 focus:ring-blue-500" placeholder="Ej: Juan David Pérez" />
            </div>
